    ...
    >
      <AnimatedSection className="mx-auto max-w-7xl">
        ...
        <div className="relative">
          <div className="absolute left-3 top-0 h-full w-0.5 bg-slate-200 dark:bg-slate-700 sm:left-5"></div>
          <div className="space-y-8">
            {experiences.map((item, idx) => {
              ...
              <div key={idx} className="relative pl-10 sm:pl-14">
                <div className="absolute left-1.5 top-1 flex h-4 w-4 items-center justify-center rounded-full border-2 border-white bg-blue-500 shadow-sm dark:border-slate-900 sm:left-3"></div>
                <div className="rounded-2xl border border-slate-100 bg-white p-4 shadow-sm transition hover:shadow-md dark:border-slate-800 dark:bg-slate-950 sm:p-6">
